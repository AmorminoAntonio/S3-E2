...
changePcontent("Nuovo testo per i miei paragrafi !!");
...
const addToTheSecond = function () {
  ...
  const nuovoElemList2 = document.createElement("li");
  nuovoElemList2.innerText = "4rd";
  List2.appendChild(nuovoElemList2);
};
addToTheSecond();
